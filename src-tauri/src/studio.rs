    ...
    fn default() -> Self {
        Self {
            ...
            assets: vec![
                ...
                AssetItem {
                    id: "asset-cordtools-icon".to_string(),
                    key: "cordtools-icon".to_string(),
                    kind: "Small image".to_string(),
                    tone: "CordTools badge".to_string(),
                    preview_data_url: Some("/rpc/cordtools-icon.png".to_string()),
                },
                AssetItem {
